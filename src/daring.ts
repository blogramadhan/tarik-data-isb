...
async function fetchAndSave() {
    console.log("🚀 Memulai proses download data DARING");
    ...
    console.log(`🎉 Download data DARING selesai! Berhasil: ${totalDataFetched}, Gagal: ${totalDataFailed}, Dilewati: ${totalDataSkipped}`);
}
