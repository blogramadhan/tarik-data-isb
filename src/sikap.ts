...
import { daerahList, jenisDataTypes, configMap, type Daerah, type JenisData } from "./config/configSIKAP";
...
async function fetchAndSave() {
    console.log("🚀 Memulai proses download data SIKAP");
    ...
    console.log(`🎉 Download data SIKAP selesai! Berhasil: ${totalDataFetched}, Gagal: ${totalDataFailed}, Dilewati: ${totalDataSkipped}`);
}
