...
async function fetchAndSave() {
    console.log("🚀 Memulai proses download data KATALOGV6");
    ...
    console.log(`🎉 Download data KATALOGV6 selesai! Berhasil: ${totalDataFetched}, Gagal: ${totalDataFailed}, Dilewati: ${totalDataSkipped}`);
}
